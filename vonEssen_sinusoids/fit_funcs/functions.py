...
from essensine import essensine
    ...
    def __init__(self, data, funcs):
        ...
        for f in funcs:
            if f == "constant":
                ...
                self.sys_porder.append([
                    data.par_order['essena1']*data.nvisit,
                    data.par_order['essenphi1']*data.nvisit,
                    data.par_order['essena2']*data.nvisit,
                    data.par_order['essenphi2']*data.nvisit,
                    data.par_order['essena3']*data.nvisit,
                    data.par_order['essenphi3']*data.nvisit
                ]) 
            elif f == "model_ramp":
