class FormatParams: 
    ...
    def __init__(self, params, data):
        ...
        self.omega4 = params[data.par_order['omega4']*data.nvisit:(1 + data.par_order['omega4'])*data.nvisit]
        self.phi4 = params[data.par_order['phi4']*data.nvisit:(1 + data.par_order['phi4'])*data.nvisit]
        ...
        self.essena1 = params[data.par_order['essena1']*data.nvisit:(1 + data.par_order['essena1'])*data.nvisit]
        self.essenphi1 = params[data.par_order['essenphi1']*data.nvisit:(1 + data.par_order['essenphi1'])*data.nvisit]
        self.essena2 = params[data.par_order['essena2']*data.nvisit:(1 + data.par_order['essena2'])*data.nvisit]
        self.essenphi2 = params[data.par_order['essenphi2']*data.nvisit:(1 + data.par_order['essenphi2'])*data.nvisit]
        self.essena3 = params[data.par_order['essena3']*data.nvisit:(1 + data.par_order['essena3'])*data.nvisit]
        self.essenphi3 = params[data.par_order['essenphi3']*data.nvisit:(1 + data.par_order['essenphi3'])*data.nvisit]
...
def PrintParams(m, data): 
    ...
    print "omega4\t", m.params[data.par_order['omega4']*data.nvisit:(1 + data.par_order['omega4'])*data.nvisit]
    print "phi4\t", m.params[data.par_order['phi4']*data.nvisit:(1 + data.par_order['phi4'])*data.nvisit]
    ...
    """print "essena1\t", m.params[data.par_order['essena1']*data.nvisit:(1 + data.par_order['essena1'])*data.nvisit]
    print "essenphi1\t", m.params[data.par_order['essenphi1']*data.nvisit:(1 + data.par_order['essenphi1'])*data.nvisit]
    print "essena2\t", m.params[data.par_order['essena2']*data.nvisit:(1 + data.par_order['essena2'])*data.nvisit]
    print "essenphi2\t", m.params[data.par_order['essenphi2']*data.nvisit:(1 + data.par_order['essenphi2'])*data.nvisit]
    print "essena3\t", m.params[data.par_order['essena3']*data.nvisit:(1 + data.par_order['essena3'])*data.nvisit]
    print "essenphi3\t", m.params[data.par_order['essenphi3']*data.nvisit:(1 + data.par_order['essenphi3'])*data.nvisit]"""
