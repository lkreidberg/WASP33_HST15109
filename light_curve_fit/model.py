...
def calc_sys(t, params, data, visit):
    return constant(t, params, data, visit)

def calc_astro(t, params, data, visit):
...
class Model:
    ...
    def __init__(self, params, data, flags):
        ...
        for visit in range(data.nvisit):
            ...
            self.model_sys[ind] = calc_sys(t, params, data, visit)
            self.model_astro[ind] = calc_astro(t, params, data, visit)
