...
def PrintParams(m, data): 
    ...
    print "logS_gp\t", m.params[data.par_order['logS_gp']*data.nvisit:(1 + data.par_order['logS_gp'])*data.nvisit]
    print "logw_gp\t", m.params[data.par_order['logw_gp']*data.nvisit:(1 + data.par_order['logw_gp'])*data.nvisit]
    print "logQ_gp\t", m.params[data.par_order['logQ_gp']*data.nvisit:(1 + data.par_order['logQ_gp'])*data.nvisit]
    print "log_jit\t", m.params[data.par_order['log_jit']*data.nvisit:(1 + data.par_order['log_jit'])*data.nvisit]
